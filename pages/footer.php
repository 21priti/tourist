        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-md-3 mt-4">
                    <i class="fa-brands fa-phoenix-framework fs-1 text-light" ></i><span class="fs-1 ps-2 fw-bold heading-text"> Travel</span>
                    ...
                    <div class="mt-4">
                        ...
                        <a href="#" class="text-decoration-none text-light me-3"><i class="bi bi-instagram fs-5"></i> </a>
                        <a href="#" class="text-decoration-none text-light me-3"><i class="bi bi-twitter-x fs-5"></i> </a>
                    </div>
                </div>
                <div class="col-md-3">
                    <h3 class="mb-4 fw-bold heading-text">Quick Links</h3>
                ...
                <div class="col-md-3">
                    <h3 class=" mb-4 fw-bold heading-text">Contact Us</h3>
                ...
                <div class="col-md-3">
                    ...
                    <p class="text-light">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quam sit est velit quas alias itaque in odit, recusandae fugiat facere veritatis quia magni. Deleniti, consequuntur quos amet necessitatibus cumque qui?</p>
                </div>
            </div>

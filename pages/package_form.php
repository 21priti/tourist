...
<body>
    ...
    <div class="card-body">
            <div class="container text-center">
                <form action="package_form.php" method="post" class="mt-5" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12 mt-3">
                            ...
                            <span class="input-group-text"><i class="fas fa-list-ol"></i></span>
                                <input type="text" class="form-control" name="package_no" placeholder="Enter how many places available"
                                    >
                            </div>
                        </div>
                        <div class="col-md-12 mt-3">
                        ...
                        <div class="mt-3">
                            ...
                            <span class="input-group-text"><i class="fas fa-align-left"></i></span>
                                <textarea cols="15" rows="5" placeholder="Enter description"
                                    class="form-control" name="des1"></textarea>
                            </div>
                        </div>
                        <div class="mt-3">
                            <div class="input-group">
                            <span class="input-group-text"><i class="fas fa-align-left"></i></span>
                                <textarea cols="15" rows="5" placeholder="Enter description"
                                    class="form-control" name="des2"></textarea>
                            </div>
                        </div>
                        <div class="mt-3">
                            <div class="input-group">
                            <span class="input-group-text"><i class="fas fa-align-left"></i></span>
                                <textarea cols="15" rows="5" placeholder="Enter description"
                                    class="form-control" name="des3"></textarea>
                            </div>
                        </div>
                        <div class="mt-3">
                            <div class="input-group">
